create table tb_order (id bigint not null auto_increment, address varchar(255), latitude double precision, longitude double precision, moment datetime, status integer, primary key (id)) engine=InnoDB;
